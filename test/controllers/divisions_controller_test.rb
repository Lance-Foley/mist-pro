...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: {division: {name: @division.name, overtime_after: @division.overtime_after, overtime_rate: @division.overtime_rate, utlization_rate: @division.utlization_rate}}
    end
  ...
  test "should update division" do
    patch division_url(@division), params: {division: {name: @division.name, overtime_after: @division.overtime_after, overtime_rate: @division.overtime_rate, utlization_rate: @division.utlization_rate}}
