...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference("Crew.count") do
      post crews_url, params: {crew: {divsion_id: @crew.divsion_id, leader_id: @crew.leader_id, name: @crew.name}}
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: {crew: {divsion_id: @crew.divsion_id, leader_id: @crew.leader_id, name: @crew.name}}
